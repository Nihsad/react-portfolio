  ...
  return (
    <div className="resume">
      ...
      <div className="resume-info">
        ...
        <p><a href="www.linkedin.com/in/morgan-carmichael-a4b420213" target="_blank" rel="noopener noreferrer">LinkedIn</a> | <a href="https://github.com/Nihsad" target="_blank" rel="noopener noreferrer">GitHub</a></p>
        <h4>Summary</h4>
        ...
        <p>Frontend: HTML5, CSS, JQuery, Javascript, Bootstrap, SASS<br />
        Backend: MySQL, MongoDB, Express, ReactJS, Node, Handlebars</p>
        ...
        <p>Apex Pavement Solutions, LLC | Golden, CO | Office Manager<br />
          March 2020 - October 2023<br />
            <ul>
        ...
        <p>
          Pike National Historic Trail Association | Website Maintenance Assistant<br />
          <ul>
        ...
        <p>Central Colorado Eventing | Ring Steward<br />
          <ul>
        ...
        <h4>Education</h4>
        <p>University of Denver | Full-Stack Web Development Bootcamp<br />
          Dec 2023 - June 2024<br />
          Comprehensive training in HTML, CSS, JavaScript, Node.js, Express.js, React, Sequelize, MongoDB, ORM, MVC, and various APIs.</p>
      </div>
    </div>
  );
}
